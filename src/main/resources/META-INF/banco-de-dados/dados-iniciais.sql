...
insert into algaworks_ecommerce.cliente(id, nome) values (1, "Fernando Medeiros");
insert into algaworks_ecommerce.cliente(id, nome) values (2, "Marcos Mariano");

insert into algaworks_ecommerce.pedido (id, cliente_id, data_criacao, total, status) values (1, 1, sysdate(), 100.0, 'AGUARDANDO');

insert into algaworks_ecommerce.item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (1, 1, 5.0, 2);
